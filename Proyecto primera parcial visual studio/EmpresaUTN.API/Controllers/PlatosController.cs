...
namespace EmpresaUTN.API.Controllers
{
    ...
    public class PlatosController : ControllerBase
    {
        ...
        //retornar incluyendo Restaurante y la lista de ingredientes

          //incluir restaurante
             //return await _context.Platos.Include(p => p.Restaurante).ToListAsync();
        ...
        public async Task<ActionResult<Plato>> GetPlato(int id)
        {
            ...
            //mostrar plato con sus la provicia y los ingredientes
        ...
        public async Task<ActionResult<Plato>> PostPlato(Plato plato)
        {
          if (_context.Platos == null)
          {
              return Problem("Entity set 'DataContext.Plato'  is null.");
          }
